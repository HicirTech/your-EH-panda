...
const createExHeaderHeaders = () => {
    if (!userConfig.E_HENTAI_COOKIE_STRING) {
        console.error("You must provide your exHentai cookie as string");
        process.exit(1);
    }
    const eHentaiHeader:Headers = new Headers();
    eHentaiHeader.append("sec-ch-ua", "\" Not A;Brand\";v=\"99\", \"Chromium\";v=\"100\", \"Microsoft Edge\";v=\"100\"");
    ...
    eHentaiHeader.append("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.127 Safari/537.36 Edg/100.0.1185.44");
    eHentaiHeader.append("Accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9");
    ...
    eHentaiHeader.append("host", "exhentai.org");
